  ...
  return (
    <div className="card flex items-center justify-center" style={{ height: 560 }}>
      <div className="text-center">
        <div className="w-6 h-6 rounded-full border border-current border-t-transparent animate-spin mx-auto mb-3"
             style={{ color: 'var(--text-3)' }} />
        <p className="text-sm" style={{ color: 'var(--text-3)' }}>Loading map...</p>
      </div>
    </div>
  )
}
